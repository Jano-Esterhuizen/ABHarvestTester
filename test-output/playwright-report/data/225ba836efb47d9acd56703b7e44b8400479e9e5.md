...
- Name: api\general-api-case-1.api.spec.ts >> API Tests >> API-1: POST /api/auth/login with invalid credentials
- Location: tests\api\general-api-case-1.api.spec.ts:36:7
