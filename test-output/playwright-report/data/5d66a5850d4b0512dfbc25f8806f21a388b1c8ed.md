...
- Name: api\general-api-case-1.api.spec.ts >> API Tests >> API-1: POST /api/auth/login with valid credentials (Director)
- Location: tests\api\general-api-case-1.api.spec.ts:28:7
